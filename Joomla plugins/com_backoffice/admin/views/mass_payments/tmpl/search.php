...
?>
 ...
 <div class="WADASearchContainer">
      <form action="index.php?option=com_backoffice&view=mass_payments" method="get" name="WADASearchForm" id="WADASearchForm">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="WADADataTable">
          ...
          <td><input type="hidden" name="option" id="option" value="com_backoffice"/></td>
            <td><input type="hidden" name="view" id="view" value="mass_payments"/></td>
